...
const Result: FC<Props> = ({ file, result }) => {
    ...
    return (
        ...
        >
            ...
            >
                <Typography sx={{ fontFamily: 'NotoSerifKR, sans-serif' }}>인식된 얼굴</Typography>
                    ...
                    {faces.map(({ index, url }) => (
                        ...
                        >
                            {selectedFaces.includes(index) && (
                                ...
                                >
                                    <Typography sx={{ fontFamily: 'NotoSerifKR, sans-serif' }}>선택됨</Typography>
                                </Box>
                            )}
            ...
            >
                <Typography sx={{ fontFamily: 'NotoSerifKR, sans-serif' }}>인식된 음성</Typography>
                <Stack gap={1.5}>
            ...
            >
                <Typography sx={{ fontFamily: 'NotoSerifKR, sans-serif' }}>인식된 번호판</Typography>
                <Grid container spacing={1}>
                    {licensePlates.map(({ index, url }) => (
                        ...
                        >
                            ...
                            <img src={url} alt={`licensePlate${index}`} width="100%" />
                        </Grid>
                    ))}
                </Grid>
            </Stack>
            ...
            {isLoading && (
                <Typography sx={{ fontFamily: 'NotoSerifKR, sans-serif' }}>비식별화가 진행 중 입니다....</Typography>
            )}
            {deidentifiedUrl && (
                <>
                    <Button
